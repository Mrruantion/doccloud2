...
//         local_api._list('document', { type: '0|1', u_path: '^' + $.cookie('tree_path') }, '', '', 1, -1, $.cookie('appkey'), function (res) {
//             console.log(res);
//             var data = getChildren(res.data, res.data[0].id);
//             console.log(data,res.data[0].id)
//             console.log(res.data[0])
//             if ($.cookie('tree_path') == ',26,1') {
//                 $('#ul-box-1').empty();
//                 $('#ul-box-2').empty();
//                 $('#ul-box-3').empty();
//                 for(var i = 0;i<data.length;i++){
...
//                     if (data[i].name == '安监办') {
//                         ulEl = $('#ul-box-1')
//                     } else if (data[i].name == '安委办') {
//                         ulEl = $('#ul-box-2')
//                     } else if (data[i].name == '消安委办') {
//                         ulEl = $('#ul-box-3')
//                     }
//                     customText(data[i].children, ulEl)

//                 }

//                 // debugger;
//                 // console.log($('.mui-box-1').height())
//                 // 

//             } else if ($.cookie('tree_path') == ',26,1,2') {
//                 $('#ul-box-1').empty();
...
//                 // if (ele.id == 1) {
//                 var ulEl = $('#ul-box-1')
//                 // var otherData = res.data[0];
//                 // otherData.children = data;
//                 customText(data, ulEl)
//                 setCss(data, 'ul-box-1')
//             } else if ($.cookie('tree_path') == ',26,1,3') {
//                 $('#ul-box-2').empty();
//                 $('.mui-box-2').css('width', '100%')
//                 $('.mui-box-1').hide();
//                 $('.mui-box-3').hide();
//                 // var ulEl;
//                 // if (ele.id == 1) {
...
//                 // otherData.children = data;
//                 customText(data, ulEl);
//                 setCss(data, 'ul-box-2')
//             } else if ($.cookie('tree_path') == ',26,1,4') {
//                 $('#ul-box-3').empty();
//                 $('.mui-box-3').css('width', '100%')
//                 $('.mui-box-1').hide();
//                 $('.mui-box-2').hide();
//                 // var ulEl;
//                 // if (ele.id == 1) {
...
//     //         var _index = i;
//     //         dataJsonText(dataJson1.data[i], _index)
//     //     }
//     // }
